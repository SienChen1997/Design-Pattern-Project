...
import org.tiei.mall.core.util.SystemInfoPrinter;
import org.tiei.mall.db.service.mallSystemConfigService;
...
class SystemInistService {
    ...
    static {
        ...
        DEFAULT_CONFIGS.put(SystemConfig.mall_MALL_QQ, "705144434");
    }
    ...
    private Map<String, String> getSystemInfo() {
        ...
        infos.put("调试级别", environment.getProperty("logging.level.org.tiei.mall.wx"));
